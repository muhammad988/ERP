<table class="table table-bordered table-hover">
    ...
    <tr>
        <td><b>Financial Code:</b>&nbsp;&nbsp;{{$service->project->code}}</td>
...
<table class="table text-center" >
    ...
    @foreach ($service->service_items as $key=>$service_item)
        <tr>
            ...
            @if($service_item->invoice_number)
                <td>{{$service_item->invoice_number}}</td>
                <td>{{$service_item->invoice_date}}</td>
                <td>{{$service_item->currency->name_en}}</td>
                <td>{{$service_item->exchange_rate}}</td>
            @endif
