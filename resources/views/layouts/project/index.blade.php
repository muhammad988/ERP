                    ...
                    <div class=" form-group row align-items-center">
                        ...
                        <div class="col-md-2 kt-margin-b-20-tablet-and-mobile">
                            <div class="kt-form__group">
                                ...
                                <div class="kt-form__control">
                                    {!! Form::select('stage_id', $stages,null,['class' => 'form-control  kt-selectpicker','id'=>'kt_form_stage','data-live-search'=>'true','multiple']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2 kt-margin-b-20-tablet-and-mobile">
                            <div class="kt-form__group">
                                ...
                                <div class="kt-form__control">
                                    {!! Form::select('status_id', $statuses,null,['class' => 'form-control  kt-selectpicker','id'=>'kt_form_status','data-live-search'=>'true','multiple']) !!}
                                </div>
                            </div>
                        </div>
{{--                        <div class="col-md-2 kt-margin-b-20-tablet-and-mobile">--}}
