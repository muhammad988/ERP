            ...
            <div class="kt-portlet__body kt-portlet__body--fit">
                <div class="kt-grid  kt-wizard-v1 kt-wizard-v1--white" id="kt_wizard_v1"
                    ...
                    <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
                        ...
                        <form method="POST" action="{{route('project.store')}} " class="kt-form" id="kt_form">
                            @csrf
                                    ...
                                    <div class="kt-wizard-v1__form">
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea required class="form-control" id="context" name="project[context]" rows="6">{{($data_value->project->context ?? null)}}</textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea required class="form-control" id="link_to_cluster_objectives" name="project[link_to_cluster_objectives]"
                                                          rows="6">{{($data_value->project->link_to_cluster_objectives ?? null)}}</textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea required class="form-control" id="overall_objective" name="project[overall_objective]"
                                                          rows="6">{{($data_value->project->overall_objective ?? null)}}</textarea>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                                ...
                                                <div id="kt_repeater_3">
                                                    <div class="form-group  row">
                                                        <div data-repeater-list="beneficiary" class="col-lg-12">
                                                            ...
                                                            @if(isset($data_value->beneficiary))
                                                                @foreach($data_value->beneficiary as $key => $value)
                                                                    <div data-repeater-item class="row kt-margin-b-10 align-items-center">
                                                                        <div class="form-group col-lg-2">
                                                                            ...
                                                                            <select required name="organisation_unit" class=" form-control ">
                                                                                <option value="{{$value->organisation_unit}}">{{$value->option_name}}</option>
                                                                            </select>
                                                                            <input type="hidden" name="option_name" value="{{$value->option_name}}">
                                                                        </div>
                                                                ...
                                                                @endforeach
                                                            @else
                                                                <div data-repeater-item class="row kt-margin-b-10 align-items-center empty-div">
                                                                    <div class="form-group col-lg-2">
                                                                        <label>@lang('common.organisation_unit') <span class="required" aria-required="true"> *</span></label>
                                                                        <i style="float: right;" class="la la-map-marker fa-lg get_organisation_unit"></i>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                <div id="outcomes">
                                                    ...
                                                    @if(isset($data_value->description) )
                                                        @foreach($data_value->description as $key => $value)
                                                            @php
                                                                $newKey=$key+1;
                                                            @endphp
                                                            <div class="outcome" id="outcome{{$newKey}}" name="outcome{{$newKey}}">
                                                                <div class="row  form-group align-items-center">
                                                                    ...
                                                                    <div class="col-lg-10 form-group"><label>Description<span class="required" aria-required="true"> *</span></label>
                                                                        <textarea required id="outcome{{$newKey}}" name="description[]" class="form-control kt_maxlength_3 m-input" maxlength="100"
                                                                                  placeholder="Description">{{$value}}</textarea></div>
                                                                    <div class="col-lg-2">
                                                                ...
                                                                @if(isset($data_array["output_description_$newKey"]) )
                                                                    @foreach($data_array["output_description_$newKey"] as $keyOutput=> $valueOutput)
                                                                        @php
                                                                        ...
                                                                        <div class="output" id="output{{$newKey}}{{$newKeyOutput}}"
                                                                            ...
                                                                            <div class="row  form-group   align-items-center">
                                                                                ...
                                                                                <div class="col-lg-5  form-group  description"><label>Description<span class="required"
                                                                                    ...
                                                                                    <textarea required class="form-control kt_maxlength_3" maxlength="100" required="required"
                                                                                              ...
                                                                                              name="output_description_{{$newKey}}[]">{{$valueOutput}}</textarea></div>
                                                                                <div class="col-lg-5  form-group  assumption"><label>Assumption Risk<span class="required"
                                                                                                                                                          aria-required="true"> *</span></label>
                                                                                    <textarea required class="form-control kt_maxlength_3" maxlength="100" required="required"
                                                                                              placeholder="Risk &amp; Assumption 1 1"
                                                                                              id="output{{$newKey}}{{$newKeyOutput}}"
                                                                                              name="output_assumption_{{$newKey}}[]">{{$data_array["output_assumption_$newKey"][$keyOutput]}}</textarea>
                                                                                </div>
                                                                                <div class="col-lg-2">
                                                                            ...
                                                                            <div class="row output-12">
                                                                                ...
                                                                                <div class="col-lg-7 activity-7">
                                                                                    @if(isset($data_array["activity_description_$newKey$newKeyOutput"]) )
                                                                                        @foreach($data_array["activity_description_$newKey$newKeyOutput"] as $keyActivity=> $valueActivity)
                                                                                            @php
                                                                                            ...
                                                                                            <div class="activity" id="activity{{$newKey}}{{$newKeyOutput}}{{$newKeyActivity}}"
                                                                                                ...
                                                                                                <div class="row form-group align-items-center">
                                                                                                    ...
                                                                                                    <div class="col-lg-2 activity_phase  form-group "><label class="title_phase">Activity Phase<span
                                                                                                        ...
                                                                                                        {!! Form::select("activity_phase_".$newKey.$newKeyOutput."[]",$activityphase,$data_array["activity_phase_$newKey$newKeyOutput"][$keyActivity] ,['class'=>"select_activity_phase form-control" ,'required']) !!}
                                                                                                    </div>
                                                                                                    <div class="col-lg-2 responsibility  form-group ">
                                                                                                        ...
                                                                                                        <select required="required" class="form-control select_responsibility "
                                                                                                            ...
                                                                                                            <option value="{{$data_array["responsibility_$newKey$newKeyOutput"][$keyActivity]}}"
                                                                                                                    selected="selected">{{$data_array["option_name_responsibility_$newKey$newKeyOutput"][$keyActivity]}}</option>
                                                                                                        </select>
                                                                                                        <input type="hidden" name="option_name_responsibility_{{$newKey}}{{$newKeyOutput}}[]"
                                                                                                               value="{{$data_array["option_name_responsibility_$newKey$newKeyOutput"][$keyActivity]}}">
                                                                                                    </div>
                                                                                                    <div class="col-lg-2 start_date  form-group ">
                                                                                                        ...
                                                                                                        <input required="required" class="form-control  date-picker start_date_activity"
                                                                                                               value="{{$data_array["start_date_$newKey$newKeyOutput"][$keyActivity]}}"
                                                                                                    ...
                                                                                                    <div class="col-lg-2 end_date  form-group ">
                                                                                                        ...
                                                                                                        <input required="required" class="form-control  date-picker end_date_activity"
                                                                                                               data-date-format="yyyy-mm-dd" type="text"
                                                                                                               value="{{$data_array["end_date_$newKey$newKeyOutput"][$keyActivity]}}"
                                                                                                    ...
                                                                                                    <div class="col-lg-2 cost  form-group ">
                                                                                                        ...
                                                                                                        <input required="" class="form-control money"
                                                                                                               value="{{$data_array["cost_$newKey$newKeyOutput"][$keyActivity]}}"
                                                                                                               im-insert="true"
                                                                                                    ...
                                                                                                    <div class="col-lg-9  form-group  description_activity">
                                                                                                        ...
                                                                                                        <textarea required class="form-control textarea_description_activity kt_maxlength_3"
                                                                                                                  ...
                                                                                                                  name="activity_description_{{$newKey}}{{$newKeyOutput}}[]">{{$valueActivity}}</textarea>
                                                                                                    </div>
                                                                                                    <div class="col-lg-3">
                                                                                ...
                                                                                <div class="col-lg-5 indicator-5">
                                                                                    @if(isset($data_array["indicator_description_$newKey$newKeyOutput"]))
                                                                                        @foreach($data_array["indicator_description_$newKey$newKeyOutput"] as $keyIndicator=> $valueIndicator)
                                                                                            @php
                                                                                                ...
                                                                                                <div class="row  form-group   align-items-center">
                                                                                                    ...
                                                                                                    <div class="col-lg-5  form-group  indicator_description"><label>Description</label>
                                                                                                        <textarea class="form-control kt_maxlength_3" maxlength="100" required="required"
                                                                                                                  ...
                                                                                                                  name="indicator_description_{{$newKey}}{{$newKeyOutput}}[]">{{$valueIndicator}}</textarea>
                                                                                                    </div>
                                                                                                    <div class="col-lg-5  form-group  verification"><label>Verification</label>
                                                                                                        <textarea class="form-control kt_maxlength_3" maxlength="100" required="required"
                                                                                                                  ...
                                                                                                                  name="verification_{{$newKey}}{{$newKeyOutput}}[]">{{$data_array["verification_$newKey$newKeyOutput"][$keyIndicator]}}</textarea>
                                                                                                    </div>
                                                                                                    <div class="col-lg-2">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea required class="form-control" id="monitoring_and_evaluation" name="project[monitoring_evaluation]"
                                                          rows="6">{{($data_value->project->monitoring_evaluation ?? null)}}</textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                <label for="reporting">Reporting <span class="required" aria-required="true"> *</span></label>
                                                <textarea required class="form-control" id="reporting" name="project[reporting]" rows="6">{{($data_value->project->reporting ?? null)}}</textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea required class="form-control" id="gender_marker" name="project[gender_marker]"
                                                          rows="6">{{($data_value->project->gender_marker ?? null)}}</textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-12">
...
{{--                                                            @if($loop->first)--}}
                                                                Total Budget: <input style="border: none;padding-left: 3px;;background-color: #fff;" name="total_budget" readonly class="total_budget
                                                                 currency" value="{{($data_array['total_budget'] ?? null)}}">
{{--                                                            @endif--}}
                                                            Total: <input style="border: none;padding-left: 3px;;background-color: #fff;" readonly
                                                                          name="total_{{Str::replaceFirst(',','',Str::lower(Str::words($item, 1, ''))) }}"  id="total_{{Str::replaceFirst(',','',
                                                                          Str::lower(Str::words($item, 1, ''))) }}"
                                                                           class="currency" value="{{($data_array['total_'.Str::replaceFirst(',','',Str::lower(Str::words($item, 1, ''))).'']  ??
                                                                           null)}}">
                                                            ...
                                                            <div class="kt_repeater">
                                                                <div class="form-group  row">
                                                                    <div data-repeater-list="budget[{{Str::replaceFirst(',','',Str::lower(Str::words($item, 1, ''))) }}]" class="col-lg-12">
                                                                        @if(isset($data_array['budget'][Str::replaceFirst(',','',Str::lower(Str::words($item, 1, '')))]))
                                                                            @foreach($data_array['budget'][Str::replaceFirst(',','',Str::lower(Str::words($item, 1, '')))] as  $value)
                                                                                <div data-repeater-item class="kt-margin-b-10">
                                                                                    <div class="row  align-items-center">
                                                                                        ...
                                                                                        <div class="form-group col-lg-1">
                                                                                            ...
                                                                                            <input type="numeric" class="form-control chf" required onkeyup="getTotal(this)" name="chf"
                                                                                                   placeholder="CHF" value="{{$value['chf']}}">
                                                                                        </div>
                                                                                        <div class="form-group col-lg-1">
                                                                                            <label>Total <span class="required" aria-required="true"> *</span></label>
                                                                                            <input type="text" class="form-control total_one_budget total_{{Str::replaceFirst(',','',Str::lower(Str::words($item, 1, '')))}}"
                                                                                                   readonly required name="total"
                                                                                                   placeholder="Total" value="{{$value['total']}}">
                                                                                        </div>
                                                                        ...
                                                                        @else
                                                                            <div data-repeater-item class="kt-margin-b-10 empty-div">
                                                                                <div class="row  align-items-center">
                                                                                    ...
                                                                                    <div class="form-group col-lg-1">
                                                                                        <label>CHF<span class="required" aria-required="true"> *</span></label>
                                                                                        <input type="numeric" class="form-control chf" required onkeyup="getTotal(this)" name="chf" placeholder="CHF"
                                                                                               value="">
                                                                                    </div>
                                                                                    <div class="form-group col-lg-1">
                                                                                        <label>Total <span class="required" aria-required="true"> *</span></label>
                                                                                        <input type="text" class="form-control total_one_budget total_{{Str::replaceFirst(',','',Str::lower(Str::words($item, 1, '')))}}" readonly
                                                                                               required name="total"
...
<td></td>
                                        ...
                                        <td><span class="money_2">${(((Number(parseFloat((output_cost / total_cost) * 100).toFixed(2)) +
                Number(parseFloat((diffDays / days) * 100).toFixed(2))) / Number(2)) * total_indirect) / Number(100)} </span>
                                        </td>
</tr>`);
        }
    ...
    $.ajax({
    type: "POST",
    url: '{{route('project.save_And_continue')}}',
    ...
    toastr.error(data.responseJSON[key], 'Error', {
    closeButton: true, "positionClass": "toast-bottom-right",
    "onclick": null,
    "showDuration": "1000",
    "hideDuration": "1000",
