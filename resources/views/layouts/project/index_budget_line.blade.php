        ...
        <div class="kt-portlet kt-portlet--mobile">
            <div class="kt-portlet__head kt-portlet__head--lg">
                <div class="kt-portlet__head-label">
                    ...
                    <h3 class="kt-portlet__head-title">
                        @lang('common.list') @lang('common.of') @lang('project.budget') Line
                    </h3>
                </div>

            </div>
        <input value="{{$id}}" id="project_id" hidden >
...
@section('script')
    ...
    {!! Html::script('assets/app/custom/general/crud/metronic-datatable/advanced/table-budget-line.js') !!}
@stop
