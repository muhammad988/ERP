                    ...
                    <div class="kt-widget kt-widget--user-profile-1">
                        <div class="kt-widget__head">
                            ...
                            <div class="kt-widget__content">
                                <div class="kt-widget__section">
                                    ...
                                    <span class="kt-widget__subtitle"> {{Auth::user ()->position->name_en}} </span>
                                </div>
                            </div>
                        </div>
                        <div class="kt-widget__body">
                            ...
                            <div class="kt-widget__items">
                                <a href="{{ route('user.profile') }}" class="kt-widget__item ">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="kt-portlet kt-portlet--height-fluid">
                        ...
                        <form method="POST" action="{{route('user.change_password_update')}}" class="kt-form kt-form--label-right"  id="kt_form_2">
                            @csrf
