@extends('layouts.control_panel.project.service_provider.service_provider')
@section('create')
    <div class="modal fade" id="add" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">@lang('url.service-provider')</h5>
                </div>
                <div class="modal-body">
                    <form  method="POST" action="{{route('service-provider.store')}}"   id="kt_add_form" class="kt-form">
                        @csrf
                        <div class="kt-portlet__body">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-4">
                                    <label>Place<span class="required" aria-required="true"> *</span></label>
                                    <input type="text" class="form-control" id="add_place" required name="place" placeholder="Place">
                                </div>
                                <div class="form-group col-lg-4">
                                    <label>@lang('hr.phone') @lang('common.number')<span class="required" aria-required="true"> *</span></label>
...
@section('edit')
    <div class="modal fade" id="edit" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">@lang('common.edit') @lang('url.supplier')</h5>
                </div>
                <div class="modal-body">
                    <form  method="POST" action="{{route('service-provider.update',0)}}"   id="kt_edit_form" class="kt-form">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-4">
                                    <label>Place<span class="required" aria-required="true"> *</span></label>
                                    <input type="text" class="form-control" id="edit_place" required name="place" placeholder="Place">
                                </div>
                                <div class="form-group col-lg-4">
