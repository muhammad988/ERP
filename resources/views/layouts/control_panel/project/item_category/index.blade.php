@extends('layouts.control_panel.project.item_category.list')
@section('create')
    <div class="modal fade" id="add" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">@lang('url.item-category')</h5>
                </div>
                <div class="modal-body">
                    <form  method="POST" action="{{route('item-category.store')}}"   id="kt_add_form" class="kt-form">
                        @csrf
...
@section('edit')
    <div class="modal fade" id="edit" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">@lang('common.edit') @lang('url.item-category')</h5>
                </div>
                <div class="modal-body">
                    <form  method="POST" action="{{route('item-category.update',0)}}"   id="kt_edit_form" class="kt-form">
                        @method('PUT')
                        @csrf
