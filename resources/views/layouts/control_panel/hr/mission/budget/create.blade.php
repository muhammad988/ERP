            ...
            <div class="kt-portlet__body kt-portlet__body--fit">
                <div class="kt-grid  kt-wizard-v1 kt-wizard-v1--white" id="kt_wizard_v1"
                    ...
                    <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
                        ...
                        <form method="POST" action="{{route('mission.store_budget')}} " class="kt-form" id="kt_form">
                            @csrf
                            <input name="mission_budget[id]" type="hidden" value="{{$mission->id}}">
                                ...
                                <div class="kt-form__section kt-form__section--first">
                                    <div class="kt-wizard-v1__form">
                                        ...
                                        <div class="row">
                                            ...
                                            {{--                                                {!! Form::select('project[organisation_unit_id]', [],null,['class' => 'form-control select2','id'=>'organisation_unit']) !!}--}}
                                        ...
                                        <div class="kt-portlet" data-ktportlet="true" id="kt_portlet_tools_2">
                                            <div class="kt-portlet__head">
                                                ...
                                                <div class="kt-portlet__head-toolbar">
                                                    Total: <input style="border: none;padding-left: 3px;;background-color: #fff;" readonly name="total_personnel" id="total_personnel" class="currency" value="{{($data_value->total_personnel ?? null)}}">
                                                    Total Budget: <input style="border: none;padding-left: 3px;;background-color: #fff;" name="total_budget" readonly class="total_budget currency" value="{{($data_value->total_budget ?? null)}}">
                                                        ...
                                                        <div class="kt_repeater">
                                                            <div class="form-group  row">
                                                                <div data-repeater-list="personnel" class="col-lg-12">
                                                                    @if(isset($data_value->personnel))
                                                                        @foreach($data_value->personnel as $key => $value)
                                                                            <div data-repeater-item class="kt-margin-b-10">
                                                                                <div class="row  align-items-center">
                                                                                    ...
                                                                                    <div class="form-group col-lg-2">
                                                                                        ...
                                                                                        {!! Form::select('category_option_id', $category_options,$value->category_option,['class' => 'form-control select2-multiple ','required' => 'true']) !!}
                                                                                        <span class="form-text text-muted"></span>
                                                                                    </div>
                                                                                    <div class="form-group col-lg-2">
                                                                                        <label>Unit <span class="required" aria-required="true"> *</span></label>
                                                                                        {!! Form::select('unit_id', $units,$value->unit,['class' => 'form-control select2-multiple','required' => 'true']) !!}
                                                                                        <span class="form-text text-muted"></span>
                                                                                    ...
                                                                                    <div class="form-group col-lg-1">
                                                                                        ...
                                                                                        <input type="text" class="form-control total_one_budget total_personnel" readonly required name="total" placeholder="Total" value="{{$value->total}}">
                                                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="kt-portlet" data-ktportlet="true" id="kt_portlet_tools_1">
                                            <div class="kt-portlet__head">
                                                ...
                                                <div class="kt-portlet__head-toolbar">
                                                    <div class="kt-portlet__head-group">
                                                        Total: <input style="border: none;padding-left: 3px;;background-color: #fff;" readonly name="total_supplies" id="total_supplies" class="currency" value="{{($data_value->total_supplies ?? null)}}">
                                                        ...
                                                        <div class="kt_repeater">
                                                            <div class="form-group  row">
                                                                <div data-repeater-list="supplies" class="col-lg-12">
                                                                    @if(isset($data_value->supplies))
                                                                        @foreach($data_value->supplies as $key => $value)
                                                                            <div data-repeater-item class="kt-margin-b-10">
                                                                                <div class="row  align-items-center">
                                                                                    <div class="form-group col-lg-1">
                                                                                        <label>Budget Line <span class="required" aria-required="true"> *</span></label>
                                                                                    ...
                                                                                    <div class="form-group col-lg-1">
                                                                                        <label>Total <span class="required" aria-required="true"> *</span></label>
                                                                                        <input type="text" class="form-control total_one_budget total_supplies" readonly required name="total" placeholder="Total" value="{{$value->total}}">
                                                                                    </div>
                                                        ...
                                                        <div class="kt_repeater">
                                                            <div class="form-group  row">
                                                                <div data-repeater-list="equipment" class="col-lg-12">
                                                                    @if(isset($data_value->equipment))
                                                                        @foreach($data_value->equipment as $key => $value)
                                                                            <div data-repeater-item class="kt-margin-b-10">
                                                                                <div class="row  align-items-center">
                                                                                    <div class="form-group col-lg-1">
                                                                                        <label>Budget Line <span class="required" aria-required="true"> *</span></label>
                                                                                    ...
                                                                                    <div class="form-group col-lg-1">
                                                                                        <label>Total <span class="required" aria-required="true"> *</span></label>
                                                                                        <input type="text" class="form-control total_one_budget total_equipment" readonly required name="total" placeholder="Total" value="{{$value->total}}">
                                                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="kt-portlet" data-ktportlet="true" id="kt_portlet_tools_1">
                                            <div class="kt-portlet__head">
                                                ...
                                                <div class="kt-portlet__head-toolbar">
                                                    <div class="kt-portlet__head-group">
                                                        Total: <input style="border: none;padding-left: 3px;;background-color: #fff;" readonly id="total_contractual" class="currency" value="{{($data_value->total_equipment ?? null)}}">
                                                        {{--                                                        Total Budget: <input style="border: none;padding-left: 3px;;background-color: #fff;" readonly class="total_budget currency" value="{{($data_value->total_budget ?? null)}}">--}}
                                                        <a href="#" data-ktportlet-tool="toggle" class="btn btn-sm btn-icon btn-clean btn-icon-md" aria-describedby="tooltip_nrgbx2wq7w"><i class="la la-angle-down"></i></a>
                                                        {{--                        <a href="#" data-ktportlet-tool="reload" class="btn btn-sm btn-icon btn-clean btn-icon-md"><i class="la la-refresh"></i></a>--}}
                                                        {{--                        <a href="#" data-ktportlet-tool="remove" class="btn btn-sm btn-icon btn-clean btn-icon-md"><i class="la la-close"></i></a>--}}
                                                        ...
                                                        <div class="kt_repeater">
                                                            <div class="form-group  row">
                                                                <div data-repeater-list="contractual" class="col-lg-12">
                                                                    @if(isset($data_value->contractual))
                                                                        @foreach($data_value->contractual as $key => $value)
                                                                            <div data-repeater-item class="kt-margin-b-10">
                                                                                <div class="row  align-items-center">
                                                                                    <div class="form-group col-lg-1">
                                                                                        <label>Budget Line <span class="required" aria-required="true"> *</span></label>
                                                                                    ...
                                                                                    <div class="form-group col-lg-1">
                                                                                        <label>Total <span class="required" aria-required="true"> *</span></label>
                                                                                        <input type="text" class="form-control total_one_budget total_contractual" readonly required name="total" placeholder="Total" value="{{$value->total}}">
                                                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="kt-portlet" data-ktportlet="true" id="kt_portlet_tools_1">
                                            <div class="kt-portlet__head">
                                                ...
                                                <div class="kt-portlet__head-toolbar">
                                                    <div class="kt-portlet__head-group">
                                                        Total: <input style="border: none;padding-left: 3px;;background-color: #fff;" readonly id="total_travel" class="currency" value="{{($data_value->total_equipment ?? null)}}">
                                                        {{--                                                        Total Budget: <input style="border: none;padding-left: 3px;;background-color: #fff;" readonly class="total_budget currency" value="{{($data_value->total_budget ?? null)}}">--}}
                                                        <a href="#" data-ktportlet-tool="toggle" class="btn btn-sm btn-icon btn-clean btn-icon-md" aria-describedby="tooltip_nrgbx2wq7w"><i class="la la-angle-down"></i></a>
                                                        {{--                        <a href="#" data-ktportlet-tool="reload" class="btn btn-sm btn-icon btn-clean btn-icon-md"><i class="la la-refresh"></i></a>--}}
                                                        {{--                        <a href="#" data-ktportlet-tool="remove" class="btn btn-sm btn-icon btn-clean btn-icon-md"><i class="la la-close"></i></a>--}}
                                                        ...
                                                        <div class="kt_repeater">
                                                            <div class="form-group  row">
                                                                <div data-repeater-list="travel" class="col-lg-12">
                                                                    @if(isset($data_value->travel))
                                                                        @foreach($data_value->travel as $key => $value)
                                                                            <div data-repeater-item class="kt-margin-b-10">
                                                                                <div class="row  align-items-center">
                                                                                    <div class="form-group col-lg-1">
                                                                                        <label>Budget Line <span class="required" aria-required="true"> *</span></label>
                                                                                    ...
                                                                                    <div class="form-group col-lg-1">
                                                                                        <label>Total <span class="required" aria-required="true"> *</span></label>
                                                                                        <input type="text" class="form-control total_one_budget total_travel" readonly required name="total" placeholder="Total" value="{{$value->total}}">
                                                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="kt-portlet" data-ktportlet="true" id="kt_portlet_tools_1">
                                            <div class="kt-portlet__head">
                                                ...
                                                <div class="kt-portlet__head-toolbar">
                                                    <div class="kt-portlet__head-group">
                                                        Total: <input style="border: none;padding-left: 3px;;background-color: #fff;" readonly id="total_trans" class="currency" value="{{($data_value->total_trans ?? null)}}">
                                                        ...
                                                        <div class="kt_repeater">
                                                            <div class="form-group  row">
                                                                <div data-repeater-list="trans" class="col-lg-12">
                                                                    @if(isset($data_value->trans))
                                                                        @foreach($data_value->trans as $key => $value)
                                                                            <div data-repeater-item class="kt-margin-b-10">
                                                                                <div class="row  align-items-center">
                                                                                    <div class="form-group col-lg-1">
                                                                                        <label>Budget Line <span class="required" aria-required="true"> *</span></label>
                                                                                    ...
                                                                                    <div class="form-group col-lg-1">
                                                                                        <label>Total <span class="required" aria-required="true"> *</span></label>
                                                                                        <input type="text" class="form-control total_one_budget total_trans" readonly required name="total" placeholder="Total" value="{{$value->total}}">
                                                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="kt-portlet" data-ktportlet="true" id="kt_portlet_tools_1">
                                            <div class="kt-portlet__head">
                                                ...
                                                <div class="kt-portlet__head-toolbar">
                                                    <div class="kt-portlet__head-group">
                                                        Total: <input style="border: none;padding-left: 3px;;background-color: #fff;" readonly id="total_general" class="currency" value="{{($data_value->total_general ?? null)}}">
                                                        {{--                                                        Total Budget: <input style="border: none;padding-left: 3px;;background-color: #fff;" readonly class="total_budget currency" value="0">--}}
                                                        <a href="#" data-ktportlet-tool="toggle" class="btn btn-sm btn-icon btn-clean btn-icon-md" aria-describedby="tooltip_nrgbx2wq7w"><i class="la la-angle-down"></i></a>
                                                        {{--                        <a href="#" data-ktportlet-tool="reload" class="btn btn-sm btn-icon btn-clean btn-icon-md"><i class="la la-refresh"></i></a>--}}
                                                        {{--                        <a href="#" data-ktportlet-tool="remove" class="btn btn-sm btn-icon btn-clean btn-icon-md"><i class="la la-close"></i></a>--}}
                                                        ...
                                                        <div class="kt_repeater">
                                                            <div class="form-group  row">
                                                                <div data-repeater-list="general" class="col-lg-12">
                                                                    @if(isset($data_value->general))
                                                                        @foreach($data_value->general as $key => $value)
                                                                            <div data-repeater-item class="kt-margin-b-10">
                                                                                <div class="row  align-items-center">
                                                                                    <div class="form-group col-lg-1">
                                                                                        <label>Budget Line <span class="required" aria-required="true"> *</span></label>
                                                                                    ...
                                                                                    <div class="form-group col-lg-1">
                                                                                        <label>Total <span class="required" aria-required="true"> *</span></label>
                                                                                        <input type="text" class="form-control total_one_budget total_general" readonly required name="total" placeholder="Total" value="{{$value->total}}">
                                                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="kt-portlet" data-ktportlet="true" id="kt_portlet_tools_1">
                                            <div class="kt-portlet__head">
                                                ...
                                                <div class="kt-portlet__head-toolbar">
                                                    <div class="kt-portlet__head-group">
                                                        Total: <input style="border: none;padding-left: 3px;;background-color: #fff;" readonly id="total_support_cost" class="currency" value="{{($data_value->total_support_cost ?? null)}}">
                                                        {{--                                                        Total Budget: <input style="border: none;padding-left: 3px;;background-color: #fff;" readonly class="total_budget currency" value="0">--}}
                                                        <a href="#" data-ktportlet-tool="toggle" class="btn btn-sm btn-icon btn-clean btn-icon-md" aria-describedby="tooltip_nrgbx2wq7w"><i class="la la-angle-down"></i></a>
                                                        {{--                        <a href="#" data-ktportlet-tool="reload" class="btn btn-sm btn-icon btn-clean btn-icon-md"><i class="la la-refresh"></i></a>--}}
                                                        {{--                        <a href="#" data-ktportlet-tool="remove" class="btn btn-sm btn-icon btn-clean btn-icon-md"><i class="la la-close"></i></a>--}}
                                                        ...
                                                        <div class="kt_repeater">
                                                            <div class="form-group  row">
                                                                <div data-repeater-list="support_cost" class="col-lg-12">
                                                                    @if(isset($data_value->support_cost))
                                                                        @foreach($data_value->support_cost as $key => $value)
                                                                            <div data-repeater-item class="kt-margin-b-10">
                                                                                <div class="row  align-items-center">
                                                                                    <div class="form-group col-lg-1">
                                                                                        <label>Budget Line <span class="required" aria-required="true"> *</span></label>
                                                                                    ...
                                                                                    <div class="form-group col-lg-1">
                                                                                        <label>Total <span class="required" aria-required="true"> *</span></label>
                                                                                        <input type="text" class="form-control total_one_budget total_support_cost" readonly required name="total" placeholder="Total" value="{{$value->total}}">
                                                                                    </div>
