@extends('layouts.control_panel.hr.department.department')
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{route('department.store')}}" id="kt_add_form" class="kt-form">
                        @csrf
...
@section('edit_department')
    <div class="modal fade" id="edit_department" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">@lang('common.edit') @lang('common.new') @lang('common.department')</h5>
                </div>
                <div class="modal-body">
                    <form method="POST" action="{{route('department.update',0)}}" id="kt_edit_form" class="kt-form">
                        @method('PUT')
                        @csrf
