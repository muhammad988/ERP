@extends('layouts.control_panel.hr.visa_type.visa_type')

@section('create_visa_type')
    <div class="modal fade" id="add_visa_type" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">@lang('common.visa_type')</h5>
                </div>
                <div class="modal-body">
                    <form  method="POST" action="{{route('visa-type.store')}}"   id="kt_add_form" class="kt-form">
                        @csrf
...
@section('edit_visa_type')
    <div class="modal fade" id="edit_visa_type" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">@lang('common.edit')  @lang('common.visa_type')</h5>
                </div>
                <div class="modal-body">
                    <form  method="POST" action="{{route('visa-type.update',0)}}"   id="kt_edit_form" class="kt-form">
                        @method('PUT')
                        @csrf
