@extends('layouts.control_panel.hr.notification_type.list')
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">@lang('url.notification-type')</h5>
                </div>
                <div class="modal-body">
                    <form  method="POST" action="{{route('notification-type.store')}}"   id="kt_add_form" class="kt-form">
                        @csrf
                        <div class="kt-portlet__body">
                            <div class="row">
                                <div class="form-group col-xl-6">
                                    <label>Module @lang('common.name') <span class="required" aria-required="true"> *</span></label>
                                    <input type="text" id="add_module_name" class="form-control" name="module_name" placeholder="Module @lang('common.name')">
                                </div>
...
@section('edit')
    <div class="modal fade" id="edit" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">@lang('common.edit')  @lang('url.notification-type')</h5>
                </div>
                <div class="modal-body">
                    <form  method="POST" action="{{route('notification-type.update',0)}}"   id="kt_edit_form" class="kt-form">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="kt-portlet__body">
                            <div class="row">
                                    <div class="form-group col-xl-6">
                                        <label>Module @lang('common.name') <span class="required" aria-required="true"> *</span></label>
                                        <input type="text" id="edit_module_name" class="form-control" name="module_name" placeholder="Module @lang('common.name')">
                                    </div>
                            </div>
                            <div class="row">
                                    <div class="form-group col-xl-6">
