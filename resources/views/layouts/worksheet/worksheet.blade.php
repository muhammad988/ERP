            ...
            <div class="kt-portlet__head kt-portlet__head--lg">
                <div class="kt-portlet__head-label">
                    ...
                    <h3 class="kt-portlet__head-title">
                        @lang('common.list') @lang('common.of') @lang('url.worksheet')
                    </h3>
                </div>
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <button type="button" class="btn btn-brand btn-icon-sm" data-toggle="modal" data-target="#add"><i class="flaticon2-plus"></i>@lang('url.worksheet')</button>
                        <!--begin::Modal-->
                    @yield('create')
                    <!--end::Modal-->
...
@section('script')
    ...
    {!! Html::script('assets/app/custom/general/crud/metronic-datatable/advanced/table-worksheet.js') !!}
    {!! Html::script('assets/js/demo2/pages/crud/forms/validation/form-worksheet.js') !!}
    <script>
        $(".kt-selectpicker-3").selectpicker({
