                ...
                <div class="row row-no-padding row-col-separator-xl">
                    ...
                    <div class="col-md-12 col-lg-12 col-xl-3">
                        ...
                        <div class="kt-widget1">
                            ...
                            <div class="kt-widget1__item">
                                <div class="kt-widget1__info">
                                    <h3 class="kt-widget1__title">Actual Days</h3>
                                    <span class="kt-widget1__desc">{{ $leave->leave_days}}</span>
                                </div>
                            </div>
                    ...
                    <div class="col-md-12 col-lg-12 col-xl-3">
                        ...
                        <div class="kt-widget1">
                            <div class="kt-widget1__item">
                                <div class="kt-widget1__info">
                                    <h3 class="kt-widget1__title">end Date</h3>
                                    <span class="kt-widget1__desc">{{$leave->end_date}}</span>
                                </div>
                            </div>
                            <div class="kt-widget1__item">
                                <div class="kt-widget1__info">
                                    <h3 class="kt-widget1__title">Calendaring Days</h3>
                                    <span class="kt-widget1__desc">{{getDurationLeaveRequest($leave->start_date,$leave->end_date)}}</span>
                                </div>
                            </div>
