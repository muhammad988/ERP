                ...
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        <h1 class="kt-portlet__head-title">
                            Clearance For Service Request (Advance) - Office Budget
                        </h1>
                    </div>
                </div>
                <!--begin::Form-->
                <form method="POST" action="{{route('clearance.store_office')}} " class="kt-form kt-form--label-right" id="kt_form_2" novalidate="novalidate">
                    @csrf
                    <div class="kt-portlet__body">
                            ...
                            <div class="kt-section__content">
                                <div class="form-group form-group-last">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            <td style="width: 50%">@if ($service->service_method_id == 66894)
                                    ...
                                    <div class="row">
                                        <input type="text" id="service_id" value="{{$service->id}}" name="service_id" hidden>
                                        ...
                                        <div class="col-lg-2 form-group-sub">
                                            ...
                                            <input id="receipt_file" name="receipt_file" type="file" class="form-control" placeholder="receipt_file" required>
                                        </div>
                                        <div class="col-lg-2 ">
                                            <label class="form-control-label">Import Financial Clearance Items</label>
                                            <input id="items_file" name="items_file" type="file"  class="form-control" placeholder="items_file">
                                        </div>
                        ...
                        <div class="kt-section">
                            ...
                            <div class="kt-section__content">
                                <div class=" form-group form-group-last row kt_repeater_office_clearance" id="div_data">
                                    <div data-repeater-list="service_item" class="col-lg-12">
                                        <div data-repeater-item="" class="form-group row">
                                            <div class="row col-md-12">
                                                ...
                                                <div class="col-md-3" id="service_item_dev">
                                                    <div class="kt-form__group--inline">
                                                        <div class="kt-form__label">
                                            ...
                                            <div class="row col-md-12">
                                                ...
                                                <div class="col-md-1 form-group-sub">
                                                    <div class="kt-form__group--inline">
                                                        ...
                                                        <div class="kt-form__control">
                                                            <select class="form-control currency" name="currency_id" onchange="getTotal(this)"   required>
                    ...
                    <div class="kt-portlet__foot">
                        <div class="kt-form__actions">
                            <div class="row">
                                <div class="col-lg-12">
                                    <button type="button" disabled id="submit" data-ktwizard-type="action-submit" class="btn  btn-sm  btn-label-primary btn-bold "><i class="la la-check"></i> @lang('common.submit')</button>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#items_file').on('change', function () {
                ...
                let url = `/clearance/mission/import-file/${id}`;
                $.ajax({
            ...
            $(document).on('change', `.service_item`, function () {
                ...
                $(`.total_${id}`).each(function (i) {
                    if ($(this).val() != '') {
                        ...
                        if(val!=''){
                            if (currency[$(`.currency_val_${id}:eq(${i})`).val()] <= currency['{{$service->currency_id}}']) {
                ...
                if (old_id != '') {
                    ...
                    $(`.total_${old_id}`).each(function (i) {
                        if ($(this).val() != '') {
                            ...
                            if(val!=''){
                                if (currency[$(`.currency_val_${old_id}:eq(${i})`).val()] <= currency['{{$service->currency_id}}']) {
                ...
                document.getElementsByName('' + categoryName + '[' + num + '][currency_id]')[0].classList.add("currency_val_" + $(this).val());
                ...
                $.get('/service/get-availability-service-item/' + $(this).val(), function (data) {
                    ...
                    $(`.total_${id}`).each(function (i) {
                        if ($(this).val() != '') {
                            val= $(`.exchange_rate_val_${id}:eq(${i})`).val();
                            console.log(val);
                            console.log(currency[$(`.currency_val_${id}:eq(${i})`).val()]);
                            console.log(currency['{{$service->currency_id}}']);
                            if(val!=''){
                                if (currency[$(`.currency_val_${id}:eq(${i})`).val()] <= currency['{{$service->currency_id}}']) {
                                    sum += Number($(this).val()) / Number(val);
                                } else {
            ...
            $(document).on('change', `.project_id`, function () {
                ...
                let categoryName = category[0];
                let num = category[1];
                let x = document.getElementsByName('' + categoryName + '[' + num + '][service_item_id]')[0];
                // $('.detailed_proposal_budget_id').html('<option value="" selected>Please Select</option>');
                $.get('/service/mission_clearance/getservicebudgetline/' + $(this).val() + '/' + $("#service_id").val(), function (data) {
                    if (data) {
