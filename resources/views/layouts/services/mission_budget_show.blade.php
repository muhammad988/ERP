                            ...
                            <div class="kt-section__content">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-2 form-group-sub" id="service_receiver_dev">
                                        ...
                                        @if ($services->service_method_id == 66892)
                                        ...
                                        @else
                                            @if ($services->service_method_id == 66893)
                                                <input type="text" name="service_receiver" id="service_receiver" class="form-control" placeholder="service_receiver" value="{{$services->service_recipient->first_name_en .' '. $services->service_recipient->last_name_en}}" disabled>
                                            @else
                                                @if ($services->service_method_id == 66894)
                                                ...
                                                @else
                                                    @if ($services->service_method_id == 311432)
                                                    ...
                                                    @else
                                                        {{-- TODO: --}}
                                                        @if ($services->service_method_id == 137368)
                                ...
                                @if ($services->service_type_id != 375447 or $services->payment_method_id != 3296)
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6 form-group-sub">
                                            ...
                                            <input type="text" name="accountant_exchange_rate" id="exchange_rate" class="form-control money" placeholder="exchange rate" value="{{$services->user_exchange_rate}}" required {{$services->currency->id == 87034?'readonly':''}}>
                                        </div>
                                    </div>
                                @endif
                            </div>
                                        ...
                                        <div data-repeater-list="service_item" class="col-lg-12">
                                            @foreach ($service_items as $service_item)
                                                ...
                                                <div data-repeater-item="" class="form-group row">
                                                    <div class="col-md-3" id="project_dev">
                                                        <div class="kt-form__group--inline">
                                                            <div class="kt-form__label">
                                                                <label class="kt-label m-label--single">Project Name</label>
                                                            </div>
                                                            <div class="kt-form__control">
                                                                <input type="text" name="project_id" id="project_id" class="form-control" placeholder="project name" value="{{$service_item->detailed_proposal_budget? $service_item->project->name_en:''}}" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="d-md-none kt-margin-b-10"></div>
                                                    </div>
                                                    <div class="col-md-{{$services->service_type_id==375447&&$services->payment_method_id == 3296?'3':'2'}}" id="budget_line_dev">
                                                        <div class="kt-form__group--inline">
                                                            <div class="kt-form__label">
                                                    ...
                                                    <div class="col-md-{{$services->service_type_id==375447&&$services->payment_method_id == 3296?'2':'1'}}" id="availability_dev">
                                                        <div class="kt-form__group--inline">
                                                            ...
                                                            <div class="kt-form__control">
                                                                <input id="availability" name="availability" type="text" class="form-control kt_inputmask_6" placeholder="remaining" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    {{-- TODO: --}}
                                                    @if ($services->service_type_id == 375447 and $services->payment_method_id == 3296)
                                                        <div class="col-md-2">
                                                            <div class="kt-form__group--inline">
                                                                ...
                                                                <div class="kt-form__control">
                                                                    <input id="invoice_number" name="invoice_number" type="text" class="form-control kt_inputmask_6" placeholder="Invoice Number" value="{{$service_item->invoice_number}}" disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        {{-- TODO: --}}
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="kt-form__group--inline">
                                                            ...
                                                            <div class="kt-form__control">
                                                                <input id="availability" name="item" type="text" class="form-control kt_inputmask_6" value="{{$service_item->item->name_en}}" placeholder="item" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="d-md-none kt-margin-b-10"></div>
                                                    </div>
                                                    <div class="col-md-1">
                                                        <div class="kt-form__group--inline">
                                                            ...
                                                            <div class="kt-form__control">
                                                                <input id="availability" name="item" type="text" class="form-control kt_inputmask_6" value="{{$service_item->unit->name_en}}" placeholder="item" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="d-md-none kt-margin-b-10"></div>
                                                    </div>
                                                    ...
                                                    @if ($services->service_type_id == 375447 and $services->payment_method_id == 3296)
                                                        <div class="col-md-1">
                                                            <div class="kt-form__group--inline">
                                                                ...
                                                                <div class="kt-form__control">
                                                                    <input id="currency_id" name="currency_id" type="text" class="form-control money" placeholder="currency" value="{{$service_item->currency->name_en}}" disabled>
                                                                </div>
                                                            </div>
                                                            <div class="d-md-none kt-margin-b-10"></div>
                                                        </div>
                                                    ...
                                                    {{-- TODO: --}}
                                                    <div class="col-md-{{$services->service_type_id==375447&&$services->payment_method_id == 3296?'3':'12'}}">
                                                        <div class="kt-form__group--inline">
                                                            <div class="kt-form__label">
                                                                <label>Note</label>
                                                            </div>
                            ...
                            <div class="kt-section__content">
                                <div class="form-group row">
                                    ...
                                    @if($services->currency_id != 87034 and $services->currency_id != "")
                                        <div class="col-lg-6 form-group-sub">
                                            <label class="form-control-label">Total Currecy {{$services->currency->name_en}}</label>
