...
@section('content')
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 50%"><b>Clearance Code:</b>&nbsp;&nbsp;{{$service->parent->code}}</td>
                                            </tr>
                                            <tr>
    ...
    <form id="reject-form" action="{{route ('clearance.action_office')}}" method="POST" hidden>
        @csrf
        <input hidden name="action" value="reject">
        <input hidden name="id" value="{{$service->id}}">
    </form>
    <form id="confirm-form" action="{{route ('clearance.action_office')}}" method="POST" hidden>
        @csrf
        <input hidden name="action" value="confirm">
        <input hidden name="id" value="{{$service->id}}">
    </form>
    <form id="accept-form" action="{{route ('clearance.action_office')}}" method="POST" hidden>
        @csrf
