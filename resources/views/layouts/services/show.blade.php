    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
        <div class="col-lg-12">
            <div class="kt-portlet">
                ...
                <!--begin::Form-->
                <form method="POST" action="{{route('service.update')}}" class="kt-form kt-form--label-right" id="kt_form_2" novalidate="novalidate">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="kt-section__content">
                                ...
                                <div class="form-group row">
                                    ...
                                    @if ($service->project_id)
                                        <div class="col-lg-3 form-group-sub" id="project_name_dev">
                                            ...
                                            @foreach ($service->service_items as $service_item)
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-1">
                                                        <div class="kt-form__group--inline">
                                                            <div class="kt-form__label">
                                                                <label>Total Cost   @if($service->currency_id) ({{$service->currency->name_en}}) @endif</label>
                                                            </div>
                                                            <div class="kt-form__control">
                                    ...
                                    @if($service->currency_id)
                                        @if($service->currency_id != 87034 )
                                            <div class="col-lg-2 form-group-sub">
                                                ...
                                                <input type="text" name="total_currency" id="total_currency" class="form-control money" placeholder="total_currency" value="{{$service->total_currency}}" disabled>
                                            </div>
                                        @endif
                                    @endif
                                    <div class="col-lg-2 form-group-sub">
                                        <label class="form-control-label">Total USD</label>
                                        <input type="text" name="total_usd" id="total_usd" class="form-control money" placeholder="total_usd" value="{{$service->total_usd}}" disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    @if($check_notification->authorized)
                                        <button type="submit" id="submit" data-ktwizard-type="action-submit" class="btn  btn-sm  btn-label-primary btn-bold" disabled><i class="la la-check"></i> @lang('common.accept')</button>
...
@section('script')
    ...
    {!! Html::script('assets/js/demo2/pages/crud/forms/validation/form-controls-service-show.js') !!}
    <script>
