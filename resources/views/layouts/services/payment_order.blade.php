                ...
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        <h1 class="kt-portlet__head-title">
                            Payment Order For Service Request (Direct)
                        </h1>
                    </div>
                </div>
                <!--begin::Form-->
                <form method="POST" action="{{route('payment_order.store')}} " class="kt-form kt-form--label-right" id="kt_form_2" novalidate="novalidate">
                    @csrf
                                ...
                                <div class="form-group form-group-last">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td>{!! $service->currency_id != 87034 ? '<b>Total '.$service->currency->name_en .':</b>&nbsp;&nbsp;<span class="money">' . $total_currency .'</span>' : ''!!}</td>
                                        </tr>
                                        </tbody>
                                    </table>
