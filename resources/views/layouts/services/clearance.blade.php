                                ...
                                <div class="form-group form-group-last">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <a href="{{route ('clearance.export_invoice_template',$service->id)}}" class="btn btn-bold btn-primary" >Download</a>
                                                ...
                                                <div class="row col-md-12">
                                                    ...
                                                    <div class="col-md-2" id="availability_dev">
                                                        <div class="kt-form__group--inline">
                                                            ...
                                                            <div class="kt-form__control form-group-sub">
                                                                <input id="availability" name="availability" required type="text" class="form-control money-2 availability" placeholder="remaining" disabled>
                                                                <input name="availability_old" type="text" class="form-control availability_old " hidden disabled></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2" id="availability_dev">
                                                        <div class="kt-form__group--inline">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#items_file').on('change', function () {
                ...
                let  url= `/clearance/import-file-invoice/${project_id}/${service_id}`;
                $.ajax({
        ...
        $(document).on('change', `.total`, function () {
          let  total=0;
            setTimeout(function () {
                $(`.availability_old`).each(function (i) {
                    if ($(this).val() != '') {
                        total += Number($(this).val())-Number($('.availability:eq(' + i + ')').val());
                    }
                });
