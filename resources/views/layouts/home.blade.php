@extends('layouts.app')
@section('style')
    @include('layouts.include.style.style_dashboard')
@stop
@section('content')
            <!-- begin:: Content -->
                            ...
                            <div class="kt-portlet__head">
                                ...
                                <div class="kt-portlet__head-toolbar">
                                    <div class="kt-portlet__head-group">
                                        <a href="#" data-ktportlet-tool="fullscreen" class="btn btn-sm btn-icon btn-clean btn-icon-md"><i class="la la-expand"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="kt-portlet__body">
                                <div class="kt-scroll" data-scroll="true" data-height="270" data-scrollbar-shown="true">
...
{{--                                            </div>--}}
                ...
                <div class="row">
                    <div class="col-xl-8">
                        <div class="kt-portlet kt-portlet--height-fluid kt-portlet--mobile " data-ktportlet="true">
                                                ...
                                                <div class="kt-notification__item-icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--brand">
                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                            ...
                                                            <path d="M5,19 L20,19 C20.5522847,19 21,19.4477153 21,20 C21,20.5522847 20.5522847,21 20,21 L4,21 C3.44771525,21 3,20.5522847 3,20 L3,4 C3,3.44771525 3.44771525,3 4,3 C4.55228475,3 5,3.44771525 5,4 L5,19 Z" id="Path-95"
...
@stop
@section('script')
    @include('layouts.include.script.script_dashboard')
{{--    <script  src="js\embedded.development.js"></script>--}}
{{--    <script type="text/javascript">--}}

{{--        const client = new HelloSign({--}}
{{--            clientId: "182bea059aeffb6a3e00329e8376fda0"--}}
{{--        });--}}
{{--        client.open("https://app.hellosign.com/editor/embeddedSign?signature_id=cf429053b29d9476696163e9dc9e7889&token=8503afb410d158535d22d1cb3470b258", {--}}
{{--            testMode: true,--}}
