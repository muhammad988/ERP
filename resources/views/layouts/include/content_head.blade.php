...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-subheader__main">
        ...
        @foreach(explode('/' ,Request::path()) as $key=>$value)
            @if( $value != null)
                @if ($loop->first)
                    <h3 class="kt-subheader__title"> @lang("url.$value")</h3>
                @elseif( !is_numeric($value))
                    <span class="kt-subheader__separator kt-subheader__separator--v"></span>
                    <span class="kt-subheader__desc"> @lang("url.$value")</span>
                @endif
            @else
                <h3 class="kt-subheader__title"> @lang('url.dashboards')</h3>
                @break
            @endif
        @endforeach
    ...
    <div class="kt-subheader__toolbar">
        <div class="kt-subheader__wrapper">
            <a href="#" class="btn kt-subheader__btn-daterange" id="kt_dashboard_daterangepicker" data-toggle="kt-tooltip" title="Select dashboard daterange" data-placement="left">
                <span class="kt-subheader__btn-daterange-title" id="kt_dashboard_daterangepicker_title">@lang('common.today')</span>&nbsp;
