...
<head>
    ...
    <link href="./assets/css/demo2/pages/general/login/login-4.css" rel="stylesheet" type="text/css" />
            ...
            <div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
                <div class="kt-login__container">
                    <div class="kt-login__logo">
                        <a href="#">
                            {{Html::image('assets/media/logos/logo-2.png','')}}
                    ...
                    <div class="kt-login__signin">
                        ...
                        <form class="kt-form" action="">
                            ...
                            <div class="input-group">
                                <input class="form-control" type="text" placeholder="@lang('common.email')" name="email" autocomplete="off">
                            </div>
                            <div class="input-group">
                                <input class="form-control" type="password" placeholder="@lang('common.passport')" name="password">
                            </div>
                            <div class="row kt-login__extra">
                                ...
                                <div class="col kt-align-right">
                                    <a href="javascript:;" id="kt_login_forgot" class="kt-login__link">@lang('passwords.forget_password')</a>
                                </div>
                            </div>
                            <div class="kt-login__actions">
                                <button id="kt_login_signin_submit" class="btn btn-brand btn-pill kt-login__btn-primary">@lang('auth.sign_in')</button>
                            </div>
                        </form>
                    </div>
