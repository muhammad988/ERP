...
//
    ...
    {
        return [
            'name_en' => 'required|unique:implementing_partners',
            'name_ar' => 'required|unique:implementing_partners',
            'email' => 'required|unique:implementing_partners',
            'phone_number' => 'required|unique:implementing_partners',
