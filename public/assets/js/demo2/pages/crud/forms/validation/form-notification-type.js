...
function action_edit(id) {
    $.ajax({
        url: `/hr/control-panel/notification-type/${id}/edit`,
        dataType: 'json',
...
function action_delete(id) {
    ...
    function_delete(`/hr/control-panel/notification-type/${id}`);
