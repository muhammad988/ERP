...
function action_edit(id) {
    $.ajax({
        url: `/hr/control-panel/position-category/${id}/edit`,
        dataType: 'json',
...
function action_delete(id) {
    ...
    function_delete(`/hr/control-panel/position-category/${id}`);
