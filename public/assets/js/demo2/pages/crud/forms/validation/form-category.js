...
function action_edit(id) {
    $.ajax({
        url: `/project/control-panel/category/${id}/edit`,
        dataType: 'json',
...
function action_delete(id) {
    ...
    function_delete(`/project/control-panel/category/${id}`);
