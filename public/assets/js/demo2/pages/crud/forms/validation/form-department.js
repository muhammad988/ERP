    ...
    let add_department = function () {
        validator_add = add_form.validate({
            ...
            invalidHandler: function (event, validator) {
                // swal.fire({
                //     "title": "",
                //     "text": "There are some errors in your subdepartment. Please correct them.",
                //     "type": "error",
...
function action_edit(id) {
    $.ajax({
        url: `/hr/control-panel/department/${id}/edit`,
        dataType: 'json',
...
function action_delete(id) {
    ...
    function_delete(`/hr/control-panel/department/${id}`);
