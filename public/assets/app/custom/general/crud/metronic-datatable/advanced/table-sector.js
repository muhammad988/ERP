    ...
    var demo = function() {
        ...
        var datatable = $('.kt-datatable').KTDatatable({
            ...
            data: {
                ...
                source: {
                    read: {
                        url: '/hr/control-panel/sector/all',
                    },
                },
...
<!--							    </div>-->
<!--							</div>-->
<button href="#" onclick="action_delete(${data.id})"  data-form-type="action-edit"  data-id="${data.id}" data-target="#edit_sector" class="btn btn-sm btn-clean btn-icon btn-icon-md test" title="Edit details">
