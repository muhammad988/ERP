    ...
    let demo = function() {
        ...
        let datatable = $('.kt-datatable').KTDatatable({
            ...
            data: {
                ...
                source: {
                    read: {
                        url: '/hr/control-panel/visa-type/all',
                    },
                },
...
<button href="#" onclick="action_delete(${data.id})"  data-form-type="action-edit"  data-id="${data.id}"  class="btn btn-sm btn-clean btn-icon btn-icon-md test" title="Edit details">
							...
							<button href="#" onclick="action_edit(${data.id})"  data-toggle="modal"  data-form-type="action-edit"  data-id="${data.id}" data-target="#edit_visa_type" class="btn btn-sm btn-clean btn-icon btn-icon-md test" title="Edit details">
