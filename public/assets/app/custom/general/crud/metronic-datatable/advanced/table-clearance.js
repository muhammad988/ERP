    ...
    let demo = function () {
        ...
        let datatable = $('.kt-datatable').KTDatatable({
            ...
            data: {
                ...
                source: {
                    read: {
                        url: `/clearance/list-clearance/${$('#id').val()}`,
                    },
                },
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: function (row, index) {
                        code=`<a href="javascript:;" class="view"  data-toggle="modal" data-target="#clearance-modal"  id="${row.id}"> ${row.code} </a>`;
                        return code;
                    }
                    ...
                    template: function (data) {
                        return `<div class="dropdown">
							    ...
							    <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a  class="dropdown-item"   href="/print/cl/${data.id}"><i class="la la-print"></i>Print</a>
							    </div>
							</div>`;
                    },
                }
