    ...
    var demo = function() {
        ...
        var datatable = $('.kt-datatable').KTDatatable({
            ...
            data: {
                ...
                source: {
                    read: {
                        url: '/hr/control-panel/position-category/all',
                    },
                },
            ...
            columns: [
                {
                    ...
                    template: function(data) {
                        return `<button href="#" onclick="action_delete(${data.id})"   data-id="${data.id}" class="btn btn-sm btn-clean btn-icon btn-icon-md test" title="Delete">
