                ...
                },
                {
                    ...
                    template: function (data) {
                        ...
                        return `<div class="dropdown">
							    ...
							    <a class="dropdown-item" ${hidden}   ${hidden_status} href="/clearance/operational-advance/create/${data.id}"><i class="la la-money"></i>Clearance</a>
                                <a class="dropdown-item"  ${hidden_status} href="/clearance/operational-advance/${data.id}"><i class="la la-list"></i>List Of Clearance</a>
