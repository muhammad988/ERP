    ...
    let demo = function () {
        ...
        let datatable = $('.kt-datatable').KTDatatable({
            ...
            data: {
                ...
                source: {
                    read: {
                        url: `/report/budget-data/${$('#project_id').val()}/${$('#budget_category_id').val()}`,
...
// 							        <a class="dropdown-item"  href="/report/budget/${data.budget_category_id}"><i class="la la-eye"></i>Budget Line</a>
// 							    </div>
// 							</div>
// 							`;
//                     },
