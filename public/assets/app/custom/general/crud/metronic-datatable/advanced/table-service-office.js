            ...
            columns: [
                ...
                },
                {
                    ...
                    template: function (row, index) {
                        code=`<a href="javascript:;" class="view"  data-toggle="modal" data-target="#service-office-modal"  id="${row.id}"> ${row.code} </a>`;
                        return code;
                    }
                },{
                    field: 'service_type',
                ...
                },
                {
                    ...
                    template: function (data) {
                        if (data.payment_method_id==3296 || data.service_type_id==375446){
                             url=`<a class="dropdown-item"  href="/payment-order/office/create/${data.id}"><i class="la la-money"></i>Payment Order</a>
                                 <a class="dropdown-item"  href="/payment-order/${data.id}"><i class="la la-list"></i>List Of Payment Order</a>`;
                        }else{
                            url=`<a class="dropdown-item"  href="/clearance/office/create/${data.id}"><i class="la la-money"></i>Clearance</a>
                                <a class="dropdown-item"  href="/clearance/${data.id}"><i class="la la-list"></i>List Of Clearance</a>`;
                        }
