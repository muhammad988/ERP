...
let KTDashboard = function() {
    ...
    let _initSparklineChart = function(src, data, color, border) {
        if (src.length == 0) {
            return;
        }
    ...
    let dailySales = function() {
        let chartContainer = KTUtil.getByID('kt_chart_daily_sales');
    ...
    let profitShare = function() {
        ...
        let ctx = KTUtil.getByID('kt_chart_profit_share').getContext('2d');
        let myDoughnut = new Chart(ctx, config);
    }

    // Sales Stats.
    // Based on Chartjs plugin - http://www.chartjs.org/
    let salesStats = function() {
        ...
        let chart = new Chart(KTUtil.getByID('kt_chart_sales_stats'), config);
    }

    // Sales By KTUtillication Stats.
    // Based on Chartjs plugin - http://www.chartjs.org/
    let salesByApps = function() {
        ...
        _initSparklineChart($('#kt_chart_sales_by_apps_2_1'), [10, 21, -5, 8, -20, -2, -4, 15, 5, 8], KTApp.getStateColor('danger'), 2);
        _initSparklineChart($('#kt_chart_sales_by_apps_2_2'), [2, 17, 0, 12, 22, 5, -10, 5, 15, 2], KTApp.getStateColor('dark'), 2);
        _initSparklineChart($('#kt_chart_sales_by_apps_2_3'), [15, 6, -10, 5, 16, 22, 6, -6, -12, 5], KTApp.getStateColor('brand'), 2);
        _initSparklineChart($('#kt_chart_sales_by_apps_2_4'), [8, 19, -12, 12, 22, -2, -14, 16, 18, 2], KTApp.getStateColor('info'), 2);
    }

    // Latest Updates.
    // Based on Chartjs plugin - http://www.chartjs.org/
    let latestUpdates = function() {
        if ($('#kt_chart_latest_updates').length == 0) {
            return;
        }

        let ctx = document.getElementById("kt_chart_latest_updates").getContext("2d");
    ...
    // Trends Stats.
    // Based on Chartjs plugin - http://www.chartjs.org/
    let trendsStats = function() {
        if ($('#kt_chart_trends_stats').length == 0) {
            return;
        }

        let ctx = document.getElementById("kt_chart_trends_stats").getContext("2d");
    ...
    // Trends Stats 2.
    // Based on Chartjs plugin - http://www.chartjs.org/
    let trendsStats2 = function() {
        if ($('#kt_chart_trends_stats_2').length == 0) {
            return;
        }

        let ctx = document.getElementById("kt_chart_trends_stats_2").getContext("2d");
    ...
    // Support Tickets Chart.
    // Based on Chartjs plugin - http://www.chartjs.org/
    let supportRequests = function() {
        let container = KTUtil.getByID('kt_chart_support_requests');
    ...
    // Bandwidth Charts 1.
    // Based on Chartjs plugin - http://www.chartjs.org/
    let bandwidthChart1 = function() {
        if ($('#kt_chart_bandwidth1').length == 0) {
            return;
        }

        let ctx = document.getElementById("kt_chart_bandwidth1").getContext("2d");
    ...
    // Bandwidth Charts 2.
    // Based on Chartjs plugin - http://www.chartjs.org/
    let bandwidthChart2 = function() {
        if ($('#kt_chart_bandwidth2').length == 0) {
            return;
        }

        let ctx = document.getElementById("kt_chart_bandwidth2").getContext("2d");
    ...
    // Bandwidth Charts 2.
    // Based on Chartjs plugin - http://www.chartjs.org/
    let adWordsStat = function() {
        if ($('#kt_chart_adwords_stats').length == 0) {
            return;
        }

        let ctx = document.getElementById("kt_chart_adwords_stats").getContext("2d");
    ...
    // Bandwidth Charts 2.
    // Based on Chartjs plugin - http://www.chartjs.org/
    let financeSummary = function() {
        if ($('#kt_chart_finance_summary').length == 0) {
            return;
        }

        let ctx = document.getElementById("kt_chart_finance_summary").getContext("2d");
    ...
    let orderStatistics = function() {
        ...
        let MONTHS = ['1 Jan', '2 Jan', '3 Jan', '4 Jan', '5 Jan', '6 Jan', '7 Jan'];
    ...
    // Latest Orders
    let datatableLatestOrders = function() {

        let code = '';
        // console.log($('#kt_datatable_latest_orders').length);
    ...
    // Earnings Sliders
    // let earningsSlide = function() {
    //     let carousel1 = $('#kt_earnings_widget .kt-widget30__head .owl-carousel');
    //     let carousel2 = $('#kt_earnings_widget .kt-widget30__body .owl-carousel');
    //
    ...
    //         let index = $(this).find('.owl-item.active.center').find('.carousel').attr('data-position');
    //         if (index) {
    //             carousel2.trigger('to.owl.carousel', index);
    //         }
    //     });
    ...
    return {
        ...
        init: function() {
            ...
            // demo loading
            let loading = new KTDialog({'type': 'loader', 'placement': 'top center', 'message': 'Loading ...'});
            loading.show();
