    ...
    var Plugin = {
        ...
        updateSticky: function() {
            ...
            if (KTUtil.hasClass(body, 'kt-portlet--sticky')) {
                ...
                var width;
                if (the.options.sticky.position.width instanceof Function) {
                    width = parseInt(the.options.sticky.position.width.call());
                } else {
                    width = parseInt(the.options.sticky.position.width);
                }
                ...
                KTUtil.css(the.head, 'width', width + 'px');
            }
        },
        ...
        return new KTPortlet('kt_page_portlet', {
            sticky: {
                ...
                position: {
                    ...
                    width: function() {
                        if (KTUtil.isInResponsiveRange('desktop')) {
                            return parseInt(KTUtil.css( KTUtil.getByClass('kt-container'), 'width') );
                        }
                    },
                    left: function() {
